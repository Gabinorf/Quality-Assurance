...
suite('Unit Tests', function () {
  ...
  suite('Equality', function () {
    ...
    test('#equal, #notEqual', function () {
      ...
      assert.equal(6 * '2', '12'); // = 12
      assert.notEqual(6 + '2', '12'); // + "62"
    });
    // #6
    test('#strictEqual, #notStrictEqual', function () { // es igual a ===
  ...
  suite('Comparisons', function () {
    ...
    // #10
    test('#approximately', function () { // Asserts that the target is equal expected, to within a +/- delta range
